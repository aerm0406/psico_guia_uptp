<div id="patientModal" class="hidden fixed inset-0 z-50 bg-black/40 p-4 items-center justify-center">
    <div class="w-full max-w-3xl overflow-hidden rounded-3xl bg-white dark:bg-gray-800 shadow-2xl border-t-8 border-indigo-600">
        <div class="flex items-start justify-between gap-4 border-b border-gray-100 dark:border-gray-700 px-6 py-5">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-indigo-700 dark:text-indigo-400">Perfil del paciente</p>
        ...
        <div id="patientModalContent" class="max-h-[70vh] overflow-y-auto space-y-8 p-8">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="rounded-2xl border border-slate-100 dark:border-gray-700 bg-slate-50 dark:bg-gray-700/50 p-4 transition-colors hover:bg-white dark:hover:bg-gray-700 hover:border-indigo-200 dark:hover:border-indigo-800">
                    ...
                    <div class="md:col-span-2 rounded-2xl border border-slate-100 dark:border-gray-700 bg-slate-50 dark:bg-gray-700/50 p-4 transition-colors hover:bg-white dark:hover:bg-gray-700 hover:border-indigo-200 dark:hover:border-indigo-800">
