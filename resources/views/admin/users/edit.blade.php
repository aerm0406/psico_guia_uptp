    ...
    <div class="pt-12 pb-4 bg-slate-50 dark:bg-gray-900 min-h-[calc(100vh-4rem)]">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 text-slate-900 dark:text-white">
                ...
                <p class="mt-2 text-slate-500 dark:text-gray-400 text-sm italic">Modificando a: <span class="font-bold text-indigo-600 dark:text-indigo-400">{{ $usuario->name }} </span></p>
            </div>
