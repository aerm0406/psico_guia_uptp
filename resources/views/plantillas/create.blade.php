    ...
    <div class="py-12 bg-slate-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Crear Anexo</h2>
                    <p class="text-sm font-bold text-slate-500 dark:text-gray-400 mt-1 uppercase tracking-widest">Definición del instrumento clínico</p>
                </div>
            </div>
                ...
                <form action="{{ route('plantillas.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="titulo" required class="w-full bg-slate-50 dark:bg-gray-700 border-slate-200 dark:border-gray-600 rounded-2xl px-4 py-3 focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 transition-shadow text-gray-900 dark:text-white" placeholder="Ej: Prueba de Inteligencia" value="{{ old('titulo') }}">
